...
The mqScpData is a subset of the data from the SCoPE2 landmark paper (Specht et al. 2021). The sample annotation also comes from them. It consists of mass spectrometry-based single-cell measurements of approximately 40,000 monocytes and embryonic kidney cells each.
